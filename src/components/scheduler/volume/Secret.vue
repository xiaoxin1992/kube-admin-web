    ...
    <el-tabs v-model="activeName" class="demo-tabs">
      <el-tab-pane label="基础配置" name="basic">
        <el-row :gutter="1" style="width: 100%">
          ...
          <el-col :span="6">
            <el-form-item label="挂载权限" prop="secret.defaultMode" required>
              <el-input-number :controls="false" v-model="newVolumeConfig.secret.defaultMode" placeholder="挂载权限"></el-input-number>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="名称" prop="secret.secretName" required>
              <el-select @visibleChange="getVisibleChange" v-model="newVolumeConfig.secret.secretName" placeholder="请选择secret" style="width: 180px">
      ...
      <el-tab-pane label="自定义挂载" name="items">
        <el-table :border="true" :data="newVolumeConfig.secret.items" border striped style="width: 100%">
